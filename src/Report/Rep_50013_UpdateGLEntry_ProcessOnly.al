report 50013 UpdateGLEntry
{
    ApplicationArea = All;
    Caption = 'GL entry Correection report';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem(GLEntry; "G/L Entry")
        {
            ...
            // trigger on
            // begin
            //     recGL.SetFilter("Source No.", '=%1', 'OPENVDO2324/131');
            // end;
            ...
            begin
                ...
                if recGL.FindFirst() then begin
                    ...
                    // else
                    //     if DocNo <> '' then
                    //         recGL.Validate(recGL."Document No.", DocNo);
                    // recGL.SetFilter("Document No.", GLEntry."Document No.");
