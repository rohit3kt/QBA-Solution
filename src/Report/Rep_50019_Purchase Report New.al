report 50019 "Purchase Report New"
{
    ApplicationArea = All;
    Caption = 'Purchase report new again';
    ...
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(Posting_Date; format(PurchaseHeader."Order Date"))
            {
            }
            ...
            begin
                ...
                if PurchaseHeader."Ship To" = 'Location' then begin
                    ...
                    ShipToCode := recloc.Code;
                    ShipToName := recloc.Name;
                    if reclocstate.get(recloc."State Code") then LocState := reclocstate.Description;
                    if recloccountry.get(recloc."Country/Region Code") then loccountry := recloccountry.Name;
                    shiptoaddress := recloc.Address + ' ,' + recloc."Address 2" + ' ,' + recloc.City + ' ,' + recloc."Post Code" + ' ,' + LocState + ' ,' + loccountry;
                end
                else if PurchaseHeader."Ship To" = 'Customer Address' then begin
                    reccust.get(PurchaseHeader."Sell-to Customer No.");
                    ...
                    ShipToName := reccompinfo.Name;
                    /////
                    if reccompstate.get(reccompinfo."State Code") then compstate := reccompstate.Description;
                    if reccompcountry.get(reccompinfo."Country/Region Code") then compcountry := reccompcountry.Name;
                    //////
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/Report Layout/Purchase_Order224.rdl';
        }
    }
    var
