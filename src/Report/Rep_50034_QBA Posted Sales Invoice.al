report 50034 "QBA Posted Sales Invoice"
{
    ApplicationArea = All;
    Caption = 'QBA Posted Sales Invoice';
    UsageCategory = ReportsAndAnalysis;
    DefaultRenderingLayout = "QBA POsted Sales Invoice";
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    SlNo := 0;
                    "Sales Invoice Line".SetFilter(Quantity, '<>%1', 0);
                end;
                ...
                begin
                    ...
                    GstComponent("Sales Invoice Line");
            ...
            begin
                if StrPos("Sales Invoice Header"."No.", 'QBAEX') <> 0 then
                ...
                CustLedgerEntry_G.SetRange("Document No.", "Sales Invoice Header"."Applies-to Doc. No.");
                ...
                if "Sales Invoice Header"."Currency Code" = '' then
                    INRorUSDorEURO := 'INR'
                else if "Sales Invoice Header"."Currency Code" = 'EUR' then
                    INRorUSDorEURO := 'EUR'
                else if "Sales Invoice Header"."Currency Code" = 'USD' then
                    INRorUSDorEURO := 'USD'
                else if "Sales Invoice Header"."Currency Code" = 'GBP' then
                    INRorUSDorEURO := 'GBP';
                ...
                if Customer_G.Get("Sales Invoice Header"."Sell-to Customer No.") then
                ...
                AmtInWordsG.FormatNoText(NoText, GetDocumentAmount("Sales Invoice Header"), INRorUSDorEURO);
                ...
                if "Sales Invoice Header"."Currency Code" = 'GBP' then begin
    ...
    rendering
    {
        layout("QBA POsted Sales Invoice")
        {
            Type = RDLC;
            LayoutFile = './src/Report Layout/QBA Posted Sales Invoice.rdl';
        }
    }
    var
    ...
    local procedure GetDocumentAmount(SIH_P: Record "Sales Invoice Header"): Decimal
    var
        CustLedgEntry: Record "Cust. Ledger Entry";
        TempAmt: Decimal;
        aa: Report "GSTR-1 File Format";
    begin
        Clear(TempAmt);
        CustLedgEntry.Reset();
        ...
        if CustLedgEntry.FindFirst() then begin
            ...
            exit(CustLedgEntry.Amount);
        end;
    end;

    // local procedure GenerateQRCode(SIH_P: Record "Sales Invoice Header")
    // var
    ...
    // begin
    //     If SIH_P."QR Code".HasValue() then begin
    //         SIH_P."QR Code".CreateInStream(InStreamL);
    //         InStreamL.Read(WorkDescription);
    //     end;
    //     BarcodeFontProvider2D := Enum::"Barcode Font Provider 2D"::IDAutomation2D;
    //     BarcodeSymbology2D := Enum::"Barcode Symbology 2D"::"QR-Code";
    //     // QRCode := BarcodeFontProvider2D.EncodeFont(WorkDescription, BarcodeSymbology2D);
    // end;
}
