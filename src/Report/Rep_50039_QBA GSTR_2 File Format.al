report 50039 "QBA GSTR_2 File Format"
{
    Caption = 'QBA GSTR-2 File Format';
    ProcessingOnly = true;
    UseRequestPage = true;
    ...
    begin
        ...
        TempExcelBuffer.AddColumn('Trade Name', false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text); // Rohit
        TempExcelBuffer.AddColumn('Bill no.  (External Document No.)', false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text); // Rohit
        ...
        TempExcelBuffer.AddColumn('HSN code', false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text); // Rohit
    ...
    var
        GSTR2B2BQuery: Query QBA_GSTR2B2BQuery;
    begin
        MakeExcelHeaderB2B();
    ...
    Local procedure CreateExcelBufferB2B(GSTR2B2BQuery: Query QBA_GSTR2B2BQuery)
    var
        State: Record State;
    ...
    begin
        ...
        // >> Rohit
        if GSTR2B2BQuery.Source_Type = GSTR2B2BQuery.Source_Type::Vendor then begin
            RecVendor.Get(GSTR2B2BQuery.Source_No);
            TempExcelBuffer.AddColumn(RecVendor.Name, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        end else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);

        TempExcelBuffer.AddColumn(GSTR2B2BQuery.External_Document_No, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        // << Rohit
        ...
        TempExcelBuffer.AddColumn(GSTR2B2BQuery.HSN_SAC_Code, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text); // Rohit
    ...
    local procedure GetInvoiceType(GSTR2B2BQuery: Query QBA_GSTR2B2BQuery): Text[50]
    begin
