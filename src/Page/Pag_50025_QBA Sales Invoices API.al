page 50025 "QBAAPIV2 - Sales Invoices"
{
     APIVersion = 'v2.0';
    APIPublisher = 'QBA';
    APIGroup = 'Agentic';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(salesInvoiceLines; "QBAAPIV2 - Sales Invoice Lines")
                {
                    Caption = 'Lines';
    ...
    begin
        SetActionResponse(ActionContext, Page::"QBAAPIV2 - Sales Invoices", InvoiceId);
    end;
    ...
    begin
        ...
        SetActionResponse(ActionContext, Page::"QBAAPIV2 - Sales Credit Memos", SalesHeader.SystemId);
    end;
}