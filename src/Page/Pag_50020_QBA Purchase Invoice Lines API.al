page 50020 "QBAAPIV2 - Purch Invoice Lines"
{
    DelayedInsert = true;
    APIVersion = 'v2.0';
    APIPublisher = 'QBA';
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field(GSTCredit; Rec."GST Credit")
                {
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("GST Credit"));
                    end;
                }
                field(GstGroupCode; Rec."GST Group Code")
                {
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("GST Group Code"));
                    end;
                }
                field(HsnCode; Rec."HSN Code")
                {
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("HSN Code"));
                    end;
                }
                field(GenBusinessPostingGroup; Rec."Gen. Business Posting Group")
                {
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Gen. Business Posting Group"));
                    end;
                }
                field(GenProductPostingGroup; Rec."Gen. Product Posting Group")
                {
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Gen. Product Posting Group"));
                    end;
                }
                ...
                part(Location; "QBAAPIV2 - Locations")
                {
                    Caption = 'Location';
                    EntityName = 'location';
