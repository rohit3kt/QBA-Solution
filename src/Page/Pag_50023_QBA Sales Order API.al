page 50023 "QBAAPIV2 - Sales Orders"
{
    APIVersion = 'v2.0';
    APIPublisher = 'QBA';
    APIGroup = 'Agentic';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(dimensionSetLines; "QBAAPIV2 - Dimension Set Lines")
                {
                ...
                part(salesOrderLines; "QBAAPIV2 - Sales Order Lines")
                {
                    Caption = 'Lines';
                ...
                part(pdfDocument; "QBAAPIV2 - PDF Document")
                {
                ...
                part(attachments; "QBAAPIV2 - Attachments")
                {
                    Caption = 'Attachments';
    ...
    var
        ...
        DocumentStatusVar: Enum "Sales Document Status";
    ...
    begin
        ...
        if Invoiced then
            SetActionResponse(ActionContext, SalesInvoiceAggregator.GetSalesInvoiceHeaderId(SalesInvoiceHeader), Page::"QBAAPIV2 - Sales Invoices", WebServiceActionResultCode::Deleted)
        else
            SetActionResponse(ActionContext, SalesHeader.SystemId, Page::"QBAAPIV2 - Sales Orders", WebServiceActionResultCode::Updated);
    end;
    ...
    begin
        ...
        if SalesHeader.Get(SalesHeader."Document Type"::Order, Rec."No.") then
            DocumentStatusVar := SalesHeader.Status;
    end;
}
