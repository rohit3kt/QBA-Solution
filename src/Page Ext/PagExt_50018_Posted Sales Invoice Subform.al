pageextension 50018 PostedSalesInvoiceSubform extends "Posted Sales Invoice Subform"
{
    layout
    {
        ...
        {
            field("Total GST Amount(INR)"; TotalIGSTAmt + TotalCGSTAmount + TotalSGSTAmt)
            {
                ApplicationArea = all;
            }
            field("Total Amount Incl. GST"; TotalIGSTAmt + TotalCGSTAmount + TotalSGSTAmt + rec."Amount Including VAT")
            {
                ApplicationArea = all;
            }
        }
