pageextension 50093 SalesCrMemoSubform extends "Sales Cr. Memo Subform"
{
    layout
    {
        ...
        //     { Caption = 'Total GST Amount'; ApplicationArea = all; }
        ...
        addafter("Total Amount Excl. VAT")
        {
            ...
            field(TotalAmtIncludingGST; TotalCGSTAmount + TotalSGSTAmt + TotalIGSTAmt + TotalLineAmount)
            {
                ApplicationArea = all;
                Caption = 'Total Amount Including GST';
            }
    ...
    var TotalAmtIncludingGST: Decimal;
    label1: Label 'Unit Price Excl. GST';
